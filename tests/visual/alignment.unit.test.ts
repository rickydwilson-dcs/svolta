...
describe('calculateDimensions', () => {
  it('applies aspect ratio to total canvas dimensions', () => {
    expect(calculateDimensions('1:1', 1080)).toEqual({ width: 1080, height: 1080, halfWidth: 540 });
    expect(calculateDimensions('4:5', 1080)).toEqual({ width: 1080, height: 1350, halfWidth: 540 });
    expect(calculateDimensions('9:16', 1080)).toEqual({ width: 1080, height: 1920, halfWidth: 540 });
  });
});
