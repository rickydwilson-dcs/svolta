        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              ...
              // Note: @imgly/background-removal uses new Function() in WASM bootstrap, requiring 'unsafe-eval'
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' 'wasm-unsafe-eval' blob: https://js.stripe.com https://*.supabase.co https://cdn.jsdelivr.net https://vercel.live",
